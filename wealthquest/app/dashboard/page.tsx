  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {/* World Banner */}
        <div className="bg-gradient-to-br from-green-900 via-green-800 to-green-700 rounded-2xl p-5 mb-5 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div>
              <div className="flex justify-between text-xs text-green-300 mb-1">
                <span>Chapter Progress</span><span>{completedCount} / 5 quests</span>
              </div>
              <div className="h-2 bg-green-900 rounded-full overflow-hidden">
                <div className="h-full bg-yellow-400 rounded-full transition-all" style={{ width: `${(completedCount / 5) * 100}%` }} />
              </div>
            </div>
          </div>
        </div>
